(function () {
  ...
  CHARACTER_SKILL_BOOK.sasuke.slots[5].skill = {
    ...
    susanoScale: 3.3,
    susanoVerticalOffsetPercent: -0.07,
  ...
  const JutsuSystem = {
    ...
    buildSkillPayload(skill) {
      ...
      return {
        ...
        susanoVerticalOffsetPercent: toNumber(skill.susanoVerticalOffsetPercent, 0),
        ...
        chidoriNagashiSlowMo: toNumber(skill.chidoriNagashiSlowMo, 0.23),
        chidoriNagashiDarkness: toNumber(skill.chidoriNagashiDarkness, 0.45),
        chidoriNagashiRetreatDistanceRatio: toNumber(skill.chidoriNagashiRetreatDistanceRatio, 0.74),
