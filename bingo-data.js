(() => {
  ...
  const BINGO_RANK_META = Object.freeze({
    D: { label: 'Rango D', className: 'rank-d', minLevel: 1, prob: '10%', pointChance: 0.1, goldBase: 200, stat: { hp: [180, 240], atk: [35, 55], def: [20, 35], xp: [4, 8] } },
    C: { label: 'Rango C', className: 'rank-c', minLevel: 12, prob: '20%', pointChance: 0.2, goldBase: 420, stat: { hp: [260, 350], atk: [65, 95], def: [35, 55], xp: [8, 14] } },
    B: { label: 'Rango B', className: 'rank-b', minLevel: 28, prob: '30%', pointChance: 0.3, goldBase: 760, stat: { hp: [360, 460], atk: [95, 130], def: [50, 75], xp: [14, 22] } },
    A: { label: 'Rango A', className: 'rank-a', minLevel: 55, prob: '40%', pointChance: 0.4, goldBase: 1240, stat: { hp: [520, 680], atk: [140, 190], def: [75, 110], xp: [22, 34] } },
    S: { label: 'Rango S', className: 'rank-s', minLevel: 75, prob: '50%', pointChance: 0.5, goldBase: 2050, stat: { hp: [720, 940], atk: [210, 280], def: [110, 160], xp: [36, 54] } }
  });
