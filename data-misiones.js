...
(function() {
    ...
    const missionsData = {
        D: [
            ...
            { name: "Recuperar suministros robados por goblins", xp: 5, gold: 8, hp: 184, atk: 7.8, def: 6.6, lvl: 3 },
            { name: "Proteger la aldea de jabalíes", xp: 7, gold: 12, hp: 305, atk: 15.6, def: 8, lvl: 5 },
            { name: "Investigar ruinas infestadas de ratas gigantes", xp: 9, gold: 16, hp: 476, atk: 20.8, def: 27.6, lvl: 7 },
            { name: "Escoltar a un mercader (bandido)", xp: 11, gold: 18, hp: 584, atk: 29.2, def: 40.2, lvl: 9 },
            { name: "Cazar una bestia nocturna", xp: 13, gold: 20, hp: 672, atk: 67.2, def: 63.6, lvl: 12 }
        ],
        C: [
