(() => {
  ...
  const missionsData = {
    D: [
      { name: 'Eliminar lobos hambrientos', xp: 4, gold: 6, hp: 55, atk: 2, def: 1, lvl: 1 },
      { name: 'Recuperar suministros robados por goblins', xp: 6, gold: 9, hp: 220, atk: 8.6, def: 7.6, lvl: 3 },
      { name: 'Proteger la aldea de jabalíes', xp: 9, gold: 12, hp: 410, atk: 22.6, def: 21.6, lvl: 5 },
      { name: 'Investigar ruinas infestadas de ratas gigantes', xp: 12, gold: 17, hp: 617, atk: 45.7, def: 44.7, lvl: 7 },
      { name: 'Escoltar a un mercader (bandido)', xp: 16, gold: 22, hp: 874, atk: 79, def: 78, lvl: 9 },
      { name: 'Cazar una bestia nocturna', xp: 21, gold: 27, hp: 1074, atk: 127, def: 126, lvl: 12 },
    ],
    C: [
