(function () {
  const missionsData = {
    D: [
      { name: 'Eliminar lobos hambrientos', xp: 8, gold: 12, hp: 70, atk: 9, def: 3, lvl: 1 },
      { name: 'Recuperar suministros robados por goblins', xp: 13, gold: 15, hp: 174, atk: 19, def: 8, lvl: 3 },
      { name: 'Proteger la aldea de jabalíes', xp: 21, gold: 27, hp: 230, atk: 27, def: 15, lvl: 5 },
      { name: 'Investigar ruinas infestadas de ratas gigantes', xp: 30, gold: 40, hp: 300, atk: 40, def: 25, lvl: 7 },
      { name: 'Escoltar a un mercader (bandido)', xp: 37, gold: 49, hp: 420, atk: 47, def: 32, lvl: 9 },
      { name: 'Cazar una bestia nocturna', xp: 50, gold: 65, hp: 570, atk: 60, def: 37, lvl: 12 }
    ],
    C: [
