(function () {
  ...
  const CHARACTER_PROFILES = {
    ...
    itachi: { name: 'Itachi Uchiha', clanName: 'CLAN UCHIHA', formulas: { INT: ['flat', 25, 1.5], CRT: ['percent', 8, 0.3], EVA: ['percent', 5, 0.25], AGI: ['flat', 15, 2.5], MP: ['flat', 800, 9], ATK: ['flat', 12, 7], CDMG: ['percent', 20, 1.15], RES: ['percent', 5, 0.13], DEF: ['flat', 8, 4], LCK: ['flat', 2, 0.08], REGEN: ['percent', 1.5, 0.04], HP: ['flat', 1000, 10] } },
    sasuke: { name: 'Sasuke Uchiha', clanName: 'CLAN UCHIHA', formulas: { AGI: ['flat', 20, 3], ATK: ['flat', 18, 8.5], CRT: ['percent', 6, 0.28], EVA: ['percent', 4, 0.22], HP: ['flat', 1300, 14], MP: ['flat', 1000, 8.5], INT: ['flat', 15, 1], CDMG: ['percent', 25, 1.2], DEF: ['flat', 10, 4.5], REGEN: ['percent', 2.5, 0.02], LCK: ['flat', 3, 0.06], RES: ['percent', 2, 0.08] } },
