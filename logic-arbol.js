...
(function () {
    ...
    window.arbolRecibirPunto = function(cantidad, origen) {
        ...
        if (typeof window.mostrarNotificacion === 'function') {
            const mensaje = puntos === 1
                ? '🌳 Obtuviste 1 punto de habilidad para el Árbol'
                : `🌳 Obtuviste ${puntos} puntos de habilidad para el Árbol`;
            window.mostrarNotificacion(mensaje, 'arbol');
        }
