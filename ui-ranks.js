...
#arbol-root #gp{width:min(355px,100%);height:min(500px,100%);background:transparent;position:relative;overflow:hidden;border:1px solid rgba(63,168,255,.12);border-radius:6px;display:flex;flex-direction:column}
