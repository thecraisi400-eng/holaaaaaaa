  ...
  const DEFAULT_ENEMIES_BY_RANK = {
    D: {
      d_m1: {
        ...
        spriteSheet: { path: 'assets/images/enemies/rank-d/mission-1.png', frameWidth: 96, frameHeight: 96, frameCount: 1, animationFps: 6 },
        hitbox: { x: 0, y: 0, width: 96, height: 96 }
      },
      d_m2: {
        displayName: 'Goblins Saqueadores',
        spriteSheet: { path: 'assets/images/enemies/rank-d/mission-2.png', frameWidth: 96, frameHeight: 96, frameCount: 1, animationFps: 6 },
        hitbox: { x: 0, y: 0, width: 96, height: 96 }
      },
      d_m3: {
        displayName: 'Jabalí Guardián',
        spriteSheet: { path: 'assets/images/enemies/rank-d/mission-3.png', frameWidth: 96, frameHeight: 96, frameCount: 1, animationFps: 6 },
        hitbox: { x: 0, y: 0, width: 96, height: 96 }
      },
      d_m4: {
        displayName: 'Rata Gigante',
        spriteSheet: { path: 'assets/images/enemies/rank-d/mission-4.png', frameWidth: 96, frameHeight: 96, frameCount: 1, animationFps: 6 },
        hitbox: { x: 0, y: 0, width: 96, height: 96 }
      },
      d_m5: {
        displayName: 'Bandido de Escolta',
        spriteSheet: { path: 'assets/images/enemies/rank-d/mission-5.png', frameWidth: 96, frameHeight: 96, frameCount: 1, animationFps: 6 },
        hitbox: { x: 0, y: 0, width: 96, height: 96 }
      },
      d_m6: {
        displayName: 'Bestia Nocturna',
        spriteSheet: { path: 'assets/images/enemies/rank-d/mission-6.png', frameWidth: 96, frameHeight: 96, frameCount: 1, animationFps: 6 },
        hitbox: { x: 0, y: 0, width: 96, height: 96 }
      }
    },
    C: {},
